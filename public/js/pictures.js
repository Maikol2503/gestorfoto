...
let hiddenFecha = document.queryCommandIndeterm("#hidden").values;
var selectedId = -1;
var now = 0;
...
function addCard(id,values){
	...
	buttonEdit.setAttribute("onclick","openModal('edit',"+id+")")
	buttonEdit.classList.remove('offset-md-2');
	...
	buttonDelete.setAttribute('onclick','confirmDeletion('+id+')')
